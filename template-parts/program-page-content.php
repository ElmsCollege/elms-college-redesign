			  ...
			  <div id="courses">
				  <?php
			  			while ( have_rows('curriculum') ) : the_row();
				  			...
				  			echo "<div id='" .$courseID . "' class='collapseomatic noarrow'><h4>Click to view course requirements for the " . get_sub_field('curriculum_major_or_minor') . ' in ' .get_sub_field('curriculum_program_name');
				  			echo ".</h4></div><div id='swap-" .$courseID . "' class='collapseomatic noarrow' style='display: none;'><h4>Click to collapse the course requirements for the " . get_sub_field('curriculum_major_or_minor') . ' in ' .get_sub_field('curriculum_program_name');
