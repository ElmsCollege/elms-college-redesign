...
<div id="page" class="site">
    ...
    <div class="special-section-nav">
      <?php wp_nav_menu( array( 'theme_location' => 'special-nav', 'menu_id' => 'special-section-menu', 'menu_class' => 'flexRowNowrapStart justifyCenter', 'container_class' => 'special-nav-container' ) ); ?>
    </div>