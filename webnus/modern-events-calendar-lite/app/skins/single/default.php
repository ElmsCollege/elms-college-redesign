...
<div class="mec-wrap <?php echo $event_colorskin; ?> clearfix <?php echo $this->html_class; ?>" id="mec_skin_<?php echo $this->uniqueid; ?>">
    ...
    <article class="row mec-single-event content-area">
        ...
        <aside class="page-sidebar pure-u-1 pure-u-md-5-12 pure-u-lg-1-3 col-md-4">
        ...
        <main id="main" class="program-page-main site-main pure-u-1 pure-u-md-7-12 pure-u-lg-2-3 col-md-8">
            <?php echo $event->data->thumbnails; ?>
            <?php if($event->data->thumbnails['full']): ?>
