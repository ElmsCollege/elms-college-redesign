...
<div id="page" class="site">
    ...
    <div class="special-section-nav">
      <?php wp_nav_menu( array( 'theme_location' => 'library', 'menu_id' => 'special-section-menu', 'menu_class' => 'ulreset flexRowNowrapStart justifyCenter', 'container_class' => 'special-nav-container' ) ); ?>
    </div>