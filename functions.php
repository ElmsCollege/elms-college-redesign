...
function gs_elms_scripts() {
	...
	wp_enqueue_style( 'gs_elms-style', get_stylesheet_directory(), array(), filemtime(get_stylesheet_directory()) );
    ...
    wp_enqueue_style('print-styles', get_stylesheet_directory() . '/css/print.css', array(), filemtime(get_stylesheet_directory() . '/css/print.css'), 'print' );
